...
Migration `0009_phase_8_1_location_foundation.sql` remains the location schema foundation.

Migration `0010_phase_8_4_location_hardening.sql` adds database-level NaN constraints for numeric location fields.
