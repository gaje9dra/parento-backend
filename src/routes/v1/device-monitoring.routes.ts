...
export const createDeviceMonitoringRouter=(
  ...
  router.get('/admin/devices',adminAuth,requireAdminAuthorization,controller.list);
  router.get('/admin/devices/:deviceId',adminAuth,requireAdminAuthorization,controller.get);
